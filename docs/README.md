...
云原生社区 OAM SIG 主页：[https://i.cloudnative.to/oam/](https://i.cloudnative.to/oam/) （点击阅读原文可跳转到该页面），该页面使用 GitBook 组织，你可以访问 [https://github.com/cloudnativeto/sig-oam](https://github.com/cloudnativeto/sig-oam) 参与贡献。加入 OAM SIG 还可以参与更多社区的线上线下活动。
...
* Mailing List: [https://groups.google.com/forum/\#!forum/oam-dev](https://groups.google.com/forum/#!forum/oam-dev)
